...
升级 FreeBSD jail 能确保隔离环境保持安全、及时更新，并与最新功能保持同步。
...
要将 jail 升级到新的主要或次要版本，首先按照 [执行主要和次要版本升级](../di-26-zhang-freebsd-geng-xin-yu-sheng-ji/26.1.-gai-shu.md) 的说明升级主机系统。待主机系统已升级并重新启动，便可以升级 jail。
...
要将模板升级到新的主要或次要版本，首先按照 [执行主要和次要版本升级](../di-26-zhang-freebsd-geng-xin-yu-sheng-ji/26.1.-gai-shu.md) 的说明升级主机系统。待主机系统已升级并重新启动，便可以升级模板。
