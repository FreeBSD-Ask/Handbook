...
有关如何管理 jail 的更多信息，请参阅[Jail 管理](./17.6.-guan-li-jail.md)章节。
...
有关桥接的更多信息，请参阅 [Network Bridging](../di-35-zhang-gao-ji-wang-luo/35.8.-qiao-jie.md)。
...
FreeBSD 可以在 jail 内运行 Linux，利用 [Linux 二进制兼容性](../di-12-zhang-linux-er-jin-zhi-jian-rong-ceng/12.1.-gai-shu.md) 和 [debootstrap(8)](https://man.freebsd.org/cgi/man.cgi?query=debootstrap&sektion=8&format=html)。jail 无内核，它们运行在宿主机的内核上。因此，需要在宿主系统中启用 Linux 二进制兼容性。
...
更多信息，请参阅 [Linux 二进制兼容性章节](../di-12-zhang-linux-er-jin-zhi-jian-rong-ceng/12.1.-gai-shu.md)。
