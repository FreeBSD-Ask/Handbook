...
接下来，按照上述方法创建 jail，例如在 [使用 OpenZFS 快照创建瘦 jail](./17.5.-shou-jail.md#id-17.5.1.-shi-yong-openzfs-kuai-zhao-chuang-jian-shou-jail) 中所示，但 **不做** 配置。FreeBSD Linux jails 需要特定的配置，接下来将详细说明。
