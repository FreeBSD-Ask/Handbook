...
要通过 OpenZFS 快照创建瘦 jail，第一步是创建 jail 目录树，按照[设置 Jail 目录树](./17.3.-zhu-ji-pei-zhi-jail.md)中的说明进行操作。
...
有关如何管理 jail 的更多信息，请参阅[jail 管理](./17.6.-guan-li-jail.md)一节。
