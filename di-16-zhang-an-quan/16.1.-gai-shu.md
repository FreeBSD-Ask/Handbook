...
某些话题由于其复杂性，已被单独分配到专门的章节中，如 [防火墙](../di-34-zhang-fang-huo-qiang/34.1.-gai-shu.md)、[强制访问控制](../di-19-zhang-qiang-zhi-fang-wen-kong-zhi/19.1.-gai-shu.md)，以及类似 [IPsec 上的 VPN](https://docs.freebsd.org/en/articles/vpn-ipsec/) 的文章。
