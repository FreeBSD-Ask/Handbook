...
>**技巧**
>
> 如前所述，本章将介绍 OpenSSH 的基础系统版本。OpenSSH 的另一个版本可以在 [security/openssh-portable](https://cgit.freebsd.org/ports/tree/security/openssh-portable/) 中找到，它提供了更多的配置选项，并且会更频繁地更新新功能。
