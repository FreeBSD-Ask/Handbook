...
像许多优秀操作系统的生产商一样，FreeBSD 项目也有一个安全团队，负责确定每个 FreeBSD 版本的生命周期结束日期（End-of-Life，EoL），并为尚未达到 EoL 的支持版本提供安全更新。关于 FreeBSD 安全团队和受支持版本的更多信息可在 [FreeBSD 安全页面](https://www.freebsd.org/security) 查阅。
...
* 每份安全公告都会由安全官员的 PGP 密钥签名。可在 [OpenPGP Keys](../fu-lu-d.-openpgp-mi-yue/d.1.-guan-fang-cheng-yuan.md) 验证安全官员的公钥。
...
* `Problem Description` 字段解释了漏洞。这可包括有关有缺陷代码的信息以及如何恶意利用该工具。
