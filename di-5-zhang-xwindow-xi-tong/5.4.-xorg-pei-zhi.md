...
作为参考，请参见<https://en.wikipedia.org/wiki/List_of_Intel_graphics_processing_units> 或 <https://en.wikipedia.org/wiki/List_of_AMD_graphics_processing_units> ，了解支持的GPU列表。  
