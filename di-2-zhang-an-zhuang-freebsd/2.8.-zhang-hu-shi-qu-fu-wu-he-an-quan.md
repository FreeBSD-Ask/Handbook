...
* `Add User`—— [添加用户](./2.8.-zhang-hu-shi-qu-fu-wu-he-an-quan.md)中概述。
* `Root Password`——在[设置 `root` 密码](./2.8.-zhang-hu-shi-qu-fu-wu-he-an-quan.md)中概述。
* `Hostname`——在[设置主机名](./2.5.-shi-yong-bsdinstall.md)中概述。
* `Network`——在[配置网络接口](./2.8.-zhang-hu-shi-qu-fu-wu-he-an-quan.md)中概述。
* `Services`——在[启用服务](./2.8.-zhang-hu-shi-qu-fu-wu-he-an-quan.md)中概述。
* `System Hardening`——在[启用安全加固选项](./2.8.-zhang-hu-shi-qu-fu-wu-he-an-quan.md)中概述。
* `Time Zone`——在[设置时区](./2.8.-zhang-hu-shi-qu-fu-wu-he-an-quan.md)中概述。
