...
|   | 对于大型网络，静态路由很快就会变得无法扩展。FreeBSD 附带了标准的 BSD 路由守护进程 [routed（8）](https://www.freebsd.org/cgi/man.cgi?query=routed\&sektion=8\&format=html)，它提供了路由协议 RIP、版本 1 和 2 以及 IRDP。可以使用二进制包或 ports 安装 [net/zebra](https://cgit.freebsd.org/ports/tree/net/zebra/pkg-descr) 对 BGP 和 OSPF 路由协议的支持。|
| - | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   |                                                                                                                                                                                                                                                                             |
