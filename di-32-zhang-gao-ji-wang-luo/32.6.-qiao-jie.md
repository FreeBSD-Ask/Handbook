...
本节描述如何使用 [if_bridge（4）](https://www.freebsd.org/cgi/man.cgi?query=if_bridge&sektion=4&format=html) 将 FreeBSD 系统配置为网桥。还提供了网络图桥接驱动器，如 [ng_bridge（4）](https://www.freebsd.org/cgi/man.cgi?query=ng_bridge&sektion=4&format=html) 中所述。
