...
​	在这个例子中，两个客户都把 192.168.0.1 看作他们的默认网关。由于网桥缓存是粘性的，一个主机不能欺骗另	一个客户的 MAC 地址，以拦截他们的通信。
