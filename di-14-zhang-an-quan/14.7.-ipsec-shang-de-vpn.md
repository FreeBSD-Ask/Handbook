...
一般情况下，IPsec 支持在 FreeBSD 11 及更高版本上是默认启用的。对于旧的 FreeBSD 版本，应将这些选项添加到自定义内核配置文件中，然后按照[配置 FreeBSD 内核](https://docs.freebsd.org/en/books/handbook/kernelconfig/index.html#kernelconfig) 中的说明重建内核：
