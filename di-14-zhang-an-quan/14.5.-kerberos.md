...
>**注意**                                                                                            
>
>为了使客户端能够找到 Kerberos 服务，它们 *必须* 具有完整配置的 **/etc/krb5.conf** 或最简配置的 **/etc/krb5.conf**，*并且* 正确的配置 DNS 服务器。
