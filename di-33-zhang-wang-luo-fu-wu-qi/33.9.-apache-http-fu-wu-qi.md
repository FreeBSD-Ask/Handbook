...
可以通过 [www/mod\_perl2](https://cgit.freebsd.org/ports/tree/www/mod_perl2/) 软件包或 Ports 安装 **mod\_perl**。有关使用此模块的文档可以在 [http://perl.apache.org/docs/2.0/index.html](http://perl.apache.org/docs/2.0/index.html) 找到。
