...
```sh
   ...
   这行配置了客户端为 NIS 服务器密码映射中具有有效账户的任何人提供账户。通过修改此行，可以有多种方式配置 NIS 客户端。可以参考 [使用 Netgroups](./33.4.-wang-luo-xin-xi-xi-tong-nis.md) 了解一种方法。更多详细内容，请参阅 O'Reilly Media 出版的《Managing NFS and NIS》一书。
