...
要利用 bhyve 的 UEFI 支持，首先要生成 UEFI 固件镜像。你可以通过安装 [sysutils/bhyve-firmware](https://cgit.freebsd.org/ports/tree/sysutils/bhyve-firmware/pkg-descr) 的 port 或 二进制软件包来实现。
