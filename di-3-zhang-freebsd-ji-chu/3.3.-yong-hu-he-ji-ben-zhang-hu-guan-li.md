...
FreeBSD 提供了多种不同的命令来管理用户账户。最常用的命令已在 [管理用户账户的工具](./3.3.-yong-hu-he-ji-ben-zhang-hu-guan-li.md#id-3.3.1.2.-yong-hu-zhang-hu) 中总结，后面还附有一些使用示例。更多细节和使用示例请参考每个工具的手册页。
