...
要确定所安装的 port 是否有更新的版本，应使用[“Git 方法”](https://docs.freebsd.org/en/books/handbook/book/#ports-using-git-method)中说明的更新命令，确保安装了最新版本的 ports。在 FreeBSD 10 及更高版本中，或者如果系统已经转换为 pkg，下面的命令将列出已经安装的过时的 port：
