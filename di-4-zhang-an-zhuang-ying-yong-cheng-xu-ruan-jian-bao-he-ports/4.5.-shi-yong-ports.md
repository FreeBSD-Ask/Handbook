...
[ports-mgmt/portmaster](https://cgit.freebsd.org/ports/tree/ports-mgmt/portmaster/) 是非常小巧的工具，用于升级已安装的 Ports。它的设计目标是仅使用 FreeBSD 基系统中已有的工具，而不依赖其他 Ports 或数据库。要通过 Ports 安装该工具：
