...
3. 修复它！[Porter's Handbook](https://docs.freebsd.org/en/books/porters-handbook/) 包含有关 port 基础设施的详细信息，你可以用它来修复偶尔出现的问题 port，甚至提交你自己的修复！使用 [pkg 进行二进制软件包管理](./4.4.-shi-yong-pkg-jin-hang-er-jin-zhi-bao-guan-li.md) 中的说明，安装软件包而不是 port。
