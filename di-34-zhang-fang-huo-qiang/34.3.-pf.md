...
1. 安装 [mail/spamd](https://cgit.freebsd.org/ports/tree/mail/spamd/) 软件包或 Port。要使用 spamd 的灰名单功能，必须将 [fdescfs(5)](https://man.freebsd.org/cgi/man.cgi?query=fdescfs&sektion=4&format=html) 挂载到 **/dev/fd**。将以下行添加到 **/etc/fstab**：
