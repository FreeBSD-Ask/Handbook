...
* **DVD-RAM**：这是一个可重写格式，可以视为可移动硬盘。然而，这种介质与大多数 DVD-ROM 驱动器和 DVD-Video 播放器不兼容，因为只有少数 DVD 写入器支持 DVD-RAM 格式。有关 DVD-RAM 使用的更多信息，请参阅 [使用 DVD-RAM](./21.6.-chuang-jian-he-shi-yong-dvd.md)。
