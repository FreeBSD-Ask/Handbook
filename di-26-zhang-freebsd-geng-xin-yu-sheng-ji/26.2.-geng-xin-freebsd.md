...
> **注意**
>
> 请始终在 **/boot/GENERIC** 中保留 **GENERIC** 内核的副本。这对于诊断各种问题和执行版本升级非常有帮助。有关如何获取 **GENERIC** 内核副本的说明，请参见 [FreeBSD 9.X 及以后的自定义内核](./26.1.-gai-shu.md)。
...
> **注意**
>
> 如果系统运行的是自定义内核，请确保在开始升级之前，**/boot/GENERIC** 中有一份 **GENERIC** 内核副本。有关如何获取 **GENERIC** 内核的说明，请参阅 [FreeBSD 9.X 及以后的自定义内核](./26.1.-gai-shu.md)。
...
首先会对内核和内核模块打补丁。如果系统运行的是自定义内核，请使用 [nextboot(8)](https://man.freebsd.org/cgi/man.cgi?query=nextboot&sektion=8&format=html) 将下次启动的内核设置为更新后的 **/boot/GENERIC**：
...
如果临时使用了 **GENERIC** 内核，这是构建并安装新自定义内核的时机，具体步骤请参见 [配置 FreeBSD 内核](../di-10-zhang-pei-zhi-freebsd-nei-he/10.1.-gai-shu.md)。
