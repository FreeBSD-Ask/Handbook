...
应用 FreeBSD 安全补丁的过程已经简化，使管理员可以使用 `freebsd-update` 保持系统完全打上补丁。有关 FreeBSD 安全公告的更多信息，请访问 [FreeBSD 安全公告](https://docs.freebsd.org/en/books/handbook/security/#security-advisories)。
