...
|分支|更新频率|URL||-----------|-------------------------|---------------------------------------------------||main|每天两次 —— 12:00 与 00:00 UTC|`pkg+https://pkg.freebsd.org/${ABI}/base_latest`||main|每周一次 —— 周日 12:00 UTC|`pkg+https://pkg.freebsd.org/${ABI}/base_weekly`||stable/14|每天两次 —— 12:00 与 00:00 UTC|`pkg+https://pkg.freebsd.org/${ABI}/base_latest`||stable/14|每周一次 —— 周日 12:00 UTC|`pkg+https://pkg.freebsd.org/${ABI}/base_weekly`||releng/14.3|每天两次 —— 12:00 与 00:00 UTC|`pkg+https://pkg.freebsd.org/${ABI}/base_release_3`||releng/15.0|每天两次 —— 12:00 与 00:00 UTC|`pkg+https://pkg.freebsd.org/${ABI}/base_release_0`||stable/15|每天两次 —— 12:00 与 00:00 UTC|`pkg+https://pkg.freebsd.org/${ABI}/base_latest`||stable/15|每周一次 —— 周日 12:00 UTC|`pkg+https://pkg.freebsd.org/${ABI}/base_weekly`|
