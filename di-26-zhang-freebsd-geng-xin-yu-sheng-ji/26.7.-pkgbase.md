...
>**警告**
>
>由于 FreeBSD 14 的 pkgbase 仍处于实验阶段，从 14 升级到 15 的 pkgbase 主版本升级同样是实验性的。撰写本手册时，在一些极端情况下主版本升级会移除 pkg，从而导致 pkg 段错误。这是 15.0-RELEASE 的 [已知问题](https://github.com/freebsd/pkg/issues/2475)。解决方法：在升级前锁定 pkg：
>
>
>```sh
