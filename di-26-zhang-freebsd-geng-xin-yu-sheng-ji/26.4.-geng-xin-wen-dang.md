...
本节介绍了如何使用源代码或 FreeBSD Ports 集合来保持本地副本的 FreeBSD 文档的最新状态。
...
从源代码重新构建 FreeBSD 文档需要一些 FreeBSD 基础系统中不包含的工具。可以按照[FreeBSD 文档项目入门指南](https://docs.freebsd.org/en/books/fdp-primer/#overview-quick-start)中的步骤来安装所需的工具。
...
一旦将文档源代码的最新快照下载到 **/usr/doc**，就可以更新安装的文档。
