...
## 10.5.2 通过 [lpr](https://www.freebsd.org/cgi/man.cgi?query=lpr&sektion=1&format=html) 进行打印
...
### 10.5.3.2 用 [print/enscript](https://cgit.freebsd.org/ports/tree/print/enscript/pkg-descr) 让 PostScript® 打印机打出漂亮的纯文本字体
...
### 10.5.3.3 打印 PostScript® 到 PCL 打印机
...
### 10.5.5.1 [lpq(1)](https://www.freebsd.org/cgi/man.cgi?query=lpq&sektion=1&format=html)
...
### 10.5.5.2 [lprm(1)](https://www.freebsd.org/cgi/man.cgi?query=lprm&sektion=1&format=html)
...
### 10.5.5.3 [lpc(8)](https://www.freebsd.org/cgi/man.cgi?query=lpc&sektion=8&format=html)
