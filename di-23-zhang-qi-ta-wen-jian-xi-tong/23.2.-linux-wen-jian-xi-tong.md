...
从 FreeBSD 2.2 起，内核便已支持扩展文件系统（EXT）系列文件系统。[ext2fs(5)](https://man.freebsd.org/cgi/man.cgi?query=ext2fs&sektion=4&format=html) 驱动允许 FreeBSD 内核对 ext2、ext3 和 ext4 文件系统进行读写操作。
