...
[“拨入服务”](../di-29-zhang-chuan-hang-tong-xin/29.4.-bo-ru-fu-wu.md) 提供了启用拨号服务的良好说明，使用的是 [getty(8)](https://man.freebsd.org/cgi/man.cgi?query=getty&sektion=8&format=html)。
