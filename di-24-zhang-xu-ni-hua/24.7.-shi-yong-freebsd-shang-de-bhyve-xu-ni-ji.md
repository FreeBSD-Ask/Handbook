...
然而，此功能默认情况下未启用，并且需要从源代码重新编译系统。有关编译内核和自定义选项的详细描述，请参见 [从源代码构建](../di-26-zhang-freebsd-geng-xin-yu-sheng-ji/26.6.-cong-yuan-dai-ma-geng-xin-freebsd.md)。
...
为了提高安全性并将虚拟机与主机操作系统隔离，可以将 bhyve 运行在 jail 中。有关 jail 及其安全性好处的详细描述，请参见 [Jails](../di-17-zhang-jail/17.1.-gai-shu.md)。
