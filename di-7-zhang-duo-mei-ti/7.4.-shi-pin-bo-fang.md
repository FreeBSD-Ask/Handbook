...
已经准备好用 MPlayer 播放得到的 MPEG 文件 **output_vcd.mpg** 了。可以用 [multimedia/vcdimager](https://cgit.freebsd.org/ports/tree/multimedia/vcdimager/pkg-descr) 或 [sysutils/cdrdao](https://cgit.freebsd.org/ports/tree/sysutils/cdrdao/pkg-descr) 等工具将该文件刻录在 CD 介质上以创建视频 CD。
