...
> **注意**
>
> 只有在 FreeBSD 未正确检测到网络适配器时，才需要加载网络适配器模块。
>
> 例如，要加载 [alc(4)](https://man.freebsd.org/cgi/man.cgi?query=alc&sektion=4&format=html) 模块，执行以下命令：
>
> ```sh
> # kldload if_alc
> ```
>
> 若要在引导时作为模块加载驱动程序，请在 **/boot/loader.conf** 中加入以下行：
>
> ```sh
> if_alc_load="YES"
> ```
