...
一个基本的无线网络由多个在 2.4GHz 或 5GHz 频段中广播的站点组成，不过这些频段因地区而异，并且正在增加 2.3GHz 和 4.9GHz 频段。
...
第三步是添加网络接口条目，以便在引导时配置网络。使用 `sysctl net.wlan.devices` 获取网络设备接口。在下面的示例中，该 sysctl 输出显示网络设备接口为 “iwm0”。
