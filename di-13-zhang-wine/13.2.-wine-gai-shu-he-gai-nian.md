...
WINE 是一个复杂的系统，因此在 FreeBSD 系统上运行它之前，有必要先了解它是什么以及它是如何工作的。

## 13.2.1. 什么是 WINE？

正如本章的 [概述](./13.1.-gai-shu.md) 所提到的，WINE 是一个兼容层，能让 Windows® 应用程序在其他操作系统上运行。从理论上讲，这意味着这些程序应该能够在 FreeBSD、macOS 和 Android 等系统上运行。
