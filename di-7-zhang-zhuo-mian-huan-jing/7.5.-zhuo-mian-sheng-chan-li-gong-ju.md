...
|     **名称**     |      **许可证**     |             **安装包**             | **资源消耗** |
| :------------: | :--------------: | :-----------------------------: | :------: |
|   LibreOffice  |      MPL 2.0     | package\:editors/libreoffice\[] |     大    |
| Calligra Suite |   LGPL and GPL   |   package\:editors/calligra\[]  |     中    |
|     AbiWord    | GPL 2.0 or later |   package\:editors/abiword\[]   |     中    |
