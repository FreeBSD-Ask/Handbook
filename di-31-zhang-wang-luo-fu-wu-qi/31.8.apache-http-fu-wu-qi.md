...
可以使用二进制包或 ports [www/mod\_perl2](https://cgit.freebsd.org/ports/tree/www/mod\_perl2/pkg-descr) 安装 `mod_perl`。有关使用此模块的文档，请参见 [http://perl.apache.org/docs/2.0/index.html](http://perl.apache.org/docs/2.0/index.html)。
