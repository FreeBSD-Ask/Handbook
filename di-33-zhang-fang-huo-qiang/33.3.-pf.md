...
要控制 PF，可以使用 `pfctl`。 [有用的 `pfctl` 选项](./33.1.-gai-shu.md) 总结了该命令的一些常用选项。有关所有可用选项的说明，请参阅 [pfctl(8)](https://man.freebsd.org/cgi/man.cgi?query=pfctl&sektion=8&format=html)：
