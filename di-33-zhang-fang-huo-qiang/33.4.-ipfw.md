...
对于希望将 IPFW 支持静态编译到自定义内核的用户，请参阅 [IPFW 内核选项](./33.1.-gai-shu.md)。
...
为了将 IPFW 支持静态编译到自定义内核中，请参考 [Configuring the FreeBSD Kernel](../di-10-zhang-pei-zhi-freebsd-nei-he/10.1.-gai-shu.md) 中的说明。以下选项可用于自定义内核配置文件：
