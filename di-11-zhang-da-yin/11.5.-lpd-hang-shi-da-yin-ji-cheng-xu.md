...
GNUEnscript 可将纯文本文件转换为格式良好的 PostScript®，以便在 PostScript® 打印机上打印。 它会添加页码，换行长行，并提供许多其他功能，使打印的文本文件更容易阅读。 根据本地纸张大小，从 Ports 集合安装 print/enscript-letter 或 print/enscript-a4。
