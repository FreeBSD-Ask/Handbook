...
GNU Enscript 将纯文本文件转换为格式良好的 PostScript® 文件，用于在 PostScript® 打印机上打印。它添加了页码、自动换行，并提供了许多其他功能，使打印出来的文本文件更易于阅读。根据本地纸张大小，从 Ports Collection 安装 [print/enscript-letter](https://cgit.freebsd.org/ports/tree/print/enscript-letter/) 或 [print/enscript-a4](https://cgit.freebsd.org/ports/tree/print/enscript-a4/)。
...
从 Ports Collection 安装 Ghostscript PostScript® 解释器 [print/ghostscript9-base](https://cgit.freebsd.org/ports/tree/print/ghostscript9-base/)。
