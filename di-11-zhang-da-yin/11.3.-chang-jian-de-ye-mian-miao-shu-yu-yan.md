...
|输出 PDL|生成工具|备注||---------|---------|----||`PCL` 或 `PCL5`|[print/ghostscript9-base](https://cgit.freebsd.org/ports/tree/print/ghostscript9-base/)|`-sDEVICE=ljet4` 用于黑白打印，`-sDEVICE=cljet5` 用于彩色打印||`PCLXL` 或 `PCL6`|[print/ghostscript9-base](https://cgit.freebsd.org/ports/tree/print/ghostscript9-base/)|`-sDEVICE=pxlmono` 用于黑白打印，`-sDEVICE=pxlcolor` 用于彩色打印||`ESC/P2`|[print/ghostscript9-base](https://cgit.freebsd.org/ports/tree/print/ghostscript9-base/)|`-sDEVICE=uniprint`||`XQX`|[print/foo2zjs](https://cgit.freebsd.org/ports/tree/print/foo2zjs/)||
## 11.3.2. 总结
