...
[TCP wrappers](https://docs.freebsd.org/en/books/handbook/security/index.html#tcpwrappers)是一种替代机制，用于提供访问控制而不是 **安全网**。虽然这两种访问控制机制都增加一些安全性，但它们都容易受到 “IP 欺骗”攻击。所有与 NIS 相关的流量都应在防火墙处阻止。
