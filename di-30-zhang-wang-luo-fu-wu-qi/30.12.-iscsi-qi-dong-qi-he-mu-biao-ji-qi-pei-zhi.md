...
| 注意                                                                                                                                                                  |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 本节中描述的 iSCSI 启动程序从 FreeBSD 10.0-RELEASE 开始受支持。要使用旧版本中可用的 iSCSI 启动器，请参阅 [iscontrol（8）](https://www.freebsd.org/cgi/man.cgi?query=iscontrol\&sektion=8\&format=html) 。|
