...
* *Old BSD releases from the Computer Systems Research group (CSRG)*. [http://www.mckusick.com/csrg/](http://www.mckusick.com/csrg/): 这套 4CD 合集涵盖了从 1BSD 到 4.4BSD 及 4.4BSD-Lite2 的所有 BSD 版本（遗憾的是不含 2.11BSD）。最后一张光盘还收录了最终源代码及 SCCS 文件。
