...
* Raymond, Eric S. *The New Hacker's Dictionary, 3rd edition*. MIT Press, 1996. ISBN 0-262-68092-0. 亦常称作 [Jargon File](https://www.catb.org/~esr/jargon/html/index.html)
...
* *Old BSD releases from the Computer Systems Research group (CSRG)*. [https://www.mckusick.com/csrg/](https://www.mckusick.com/csrg/): 这套 4CD 合集涵盖从 1BSD 到 4.4BSD 及 4.4BSD-Lite2 的所有 BSD 版本（遗憾的是不含 2.11BSD）。最后一张光盘还收录了最终源代码及 SCCS 文件。
