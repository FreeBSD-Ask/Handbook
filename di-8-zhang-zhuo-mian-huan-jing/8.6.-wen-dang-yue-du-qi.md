...
自 UNIX® 出现以来，一些新的文档格式逐渐流行，而这些格式所需的查看器在基本系统中可能并不存在。本节介绍了如何安装以下文档查看器：
...
Evince 是一款支持多种文档格式（包括 PDF 和 Postscript）的文档查看器，属于 GNOME 项目的一部分。Evince 的目标是用单一应用程序替代像 ggv 和 gpdf 这样的文档查看器。
