...
虽然 FreeBSD 因其性能和稳定性而在服务器领域广受欢迎，但它同样非常适合作为日常使用的桌面系统。FreeBSD 的 Ports 中包含 36000 余款应用程序，因此构建能运行多种桌面应用的定制化桌面环境变得十分简单。本章演示如何安装常见的桌面环境，以及网页浏览器、办公软件、文档查看器和财务软件等桌面应用。
