...
虽然 FreeBSD 由于其性能和稳定性而广受欢迎于服务器领域，但它同样非常适合作为日常使用的桌面系统。FreeBSD 的 Ports 中包含 36000 余款应用程序，因此构建一款能够运行多种桌面应用的定制化桌面环境变得十分简单。本章演示如何安装常见的桌面环境，以及网页浏览器、办公软件、文档查看器和财务软件等桌面应用。
