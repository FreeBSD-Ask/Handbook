...
“电子邮件”（Electronic Mail），更常被称为 email，是今天最广泛使用的通讯方式之一。本章提供了在 FreeBSD 上运行邮件服务器的基本介绍，并介绍了如何使用 FreeBSD 发送和接收电子邮件。有关该主题的全面介绍，请参阅 [参考书目](../fu-lu-b.-shu-mu/b.1.-freebsd-xiang-guan-shu-ji.md) 中列出的书籍。
