...
> **注意**
>
> 习惯使用 [powerd(8)](https://man.freebsd.org/cgi/man.cgi?query=powerd&sektion=8&format=html) 或 [sysutils/powerdxx](https://cgit.freebsd.org/ports/tree/sysutils/powerdxx/) 的用户会发现 [hwpstate_intel(4)](https://man.freebsd.org/cgi/man.cgi?query=hwpstate_intel&sektion=4&format=html) 驱动程序已取代这些工具，不再按预期工作。
