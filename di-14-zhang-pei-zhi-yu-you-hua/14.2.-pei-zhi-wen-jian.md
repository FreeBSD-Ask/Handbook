...
> **技巧**
>
> **/etc/rc.conf** 和 **/etc/rc.conf.local** 都由 [sh(1)](https://man.freebsd.org/cgi/man.cgi?query=sh&sektion=1&format=html) 解析，系统操作员可以借此创建复杂的配置场景。有关此主题的更多信息，请参见 [rc.conf(5)](https://man.freebsd.org/cgi/man.cgi?query=rc.conf&sektion=5&format=html)。
