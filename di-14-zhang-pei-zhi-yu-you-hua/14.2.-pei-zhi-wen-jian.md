...
| `/etc/rc.conf` | 包含有关本地主机名、任何潜在网络接口的配置详细信息，以及应在系统初次启动时启动的服务的描述信息。更多信息请参见 [管理系统特定配置](di-14-zhang-pei-zhi-yu-you-hua/14.2.-pei-zhi-wen-jian) |
...
[`sysctl(8)`](https://man.freebsd.org/cgi/man.cgi?query=sysctl&sektion=8&format=html) 工具检索内核状态，并允许具有适当权限的进程设置内核状态。要检索或设置的状态使用“管理信息库”（“MIB”）样式的名称，描述为一个点分的组件集。
