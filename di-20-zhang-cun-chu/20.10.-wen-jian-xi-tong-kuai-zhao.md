...
UFS 快照允许用户创建指定文件系统的镜像，并将其作为文件处理。如果你使用的是 [Z 文件系统（ZFS）](../di-22-zhang-z-wen-jian-xi-tong-zfs/22.1.-shi-shi-mo-shi-zfs-yu-zhong-bu-tong.md)，请参考 [管理快照](../di-22-zhang-z-wen-jian-xi-tong-zfs/22.4.-zfs-guan-li.md) 以了解如何使用快照。
