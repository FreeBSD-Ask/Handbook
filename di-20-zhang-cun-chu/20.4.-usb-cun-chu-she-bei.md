...
如果设备尚未格式化，请参考 [添加磁盘](di-20-zhang-cun-chu/20.2.-tian-jia-ci-pan) 了解如何在 USB 驱动器上格式化并创建分区。如果驱动器已包含文件系统，可以由 `root` 按照 [“挂载和卸载文件系统”](https://docs.freebsd.org/en/books/handbook/basics/#mount-unmount) 中的说明进行挂载。
