...
> ```
>
> 生成的镜像文件可以像在 [刻录光盘](./20.5.-chuang-jian-he-shi-yong-cd.md) 中描述的那样刻录到光盘上。
...
[复制音频光盘](./20.5.-chuang-jian-he-shi-yong-cd.md) 描述了如何复制和刻录音频光盘。如果 FreeBSD 版本低于 10.0，并且设备是 ATAPI，那么必须先加载 `atapicam` 模块，加载方法可以参考 [支持的设备](./20.5.-chuang-jian-he-shi-yong-cd.md)。
...
2. 使用 `cdrecord` 将 **.wav** 文件刻录到光盘：
   ...
   请确保根据 [刻录光盘](./20.5.-chuang-jian-he-shi-yong-cd.md) 中的描述正确设置 *2,0*。
