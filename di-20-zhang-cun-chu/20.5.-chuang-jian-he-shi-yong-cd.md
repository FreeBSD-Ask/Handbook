...
FreeBSD 的 Ports  提供了多个工具，用于刻录和复制音频和数据 CD。本章展示了多个命令行工具的使用方法。如果需要带有图形界面的光盘刻录软件，可以考虑安装 [sysutils/xcdroast](https://cgit.freebsd.org/ports/tree/sysutils/xcdroast/) 或 [sysutils/k3b](https://cgit.freebsd.org/ports/tree/sysutils/k3b/) 包或端口。
