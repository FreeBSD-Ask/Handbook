...
> **技巧**
>
> 使用[Z 文件系统（ZFS）](../di-22-zhang-z-wen-jian-xi-tong-zfs/22.1.-shi-shi-mo-shi-zfs-yu-zhong-bu-tong.md)的系统可以使用[zfs(8)](https://man.freebsd.org/cgi/man.cgi?query=zfs&sektion=8&format=html)来创建快照，并使用[发送和接收](../di-22-zhang-z-wen-jian-xi-tong-zfs/22.4.-zfs-guan-li.md)功能在远程系统之间进行传输。
