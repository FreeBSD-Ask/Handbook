...
为了发送带有正确的标头 `from:` 的邮件，配置 Sendmail 使用 [user@example.net](../di-29-zhang-dian-zi-you-jian/user@example.net)，而不是 [user@bsd.home](../di-29-zhang-dian-zi-you-jian/user@bsd.home)，并且通过 `relay.example.net` 发送所有的邮件，这样可以更快地传输邮件。
