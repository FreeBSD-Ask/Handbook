...
要把所有来自 [user@example.com](../di-29-zhang-dian-zi-you-jian/user@example.com) 的邮件转发到 [goodmail@example2.com](../di-29-zhang-dian-zi-you-jian/goodmail@example2.com) 的外部地址：
...
要转发所有短于 1000 字节的邮件到 [goodmail@example2.com](../di-29-zhang-dian-zi-you-jian/goodmail@example2.com) 的外部地址：
...
要将所有发送到 [alternate@example.com](../di-29-zhang-dian-zi-you-jian/alternate@example.com) 的邮件发送到一个叫做 **alternate** 的邮箱：
