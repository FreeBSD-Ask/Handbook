...
FreeBSD 传统上使用 Unix 文件系统（UFS），其现代版本为 UFS2，是其主要的原生文件系统。FreeBSD 也使用 Z 文件系统（ZFS），该文件系统以其高级特性、健壮性和可靠性而闻名。详见 [Z 文件系统（ZFS）](../di-23-zhang-z-wen-jian-xi-tong-zfs/23.1.-shi-shi-mo-shi-zfs-yu-zhong-bu-tong.md)。
