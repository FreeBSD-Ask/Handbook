...
然而，此功能默认情况下未启用，并且需要从源代码重新编译系统。有关使用自定义选项编译内核的详细说明，请参见 [从源代码构建](../di-27-zhang-freebsd-geng-xin-yu-sheng-ji/27.6.-cong-yuan-dai-ma-geng-xin-freebsd.md)。
...
> **警告**
>
> 修改系统的 IP 地址配置可能会终止当前远程连接（例如通过 SSH 连接），导致无法访问系统！在执行这些命令时，请确保采取必要的预防措施以保持对系统的访问，或在本地终端会话中进行这些修改。
